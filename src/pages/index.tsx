  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application, your ultimate partner for efficient and seamless human resources management. Streamlining HR processes, one step at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application, your ultimate partner for efficient and seamless human resources management. Streamlining HR processes, one step at a time.`}
            </Text>
            <Box
